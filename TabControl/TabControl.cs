...
namespace Manina.Windows.Forms {
    ...
    public partial class TabControl : PagedControl {
        ...
        protected internal virtual void OnTabClick(TabMouseEventArgs e) {
            TabClick?.Invoke(this, e);
        }
        protected internal virtual void OnTabDoubleClick(TabMouseEventArgs e) {
            TabDoubleClick?.Invoke(this, e);
        }
        protected internal virtual void OnTabMouseDown(TabMouseEventArgs e) {
            TabMouseDown?.Invoke(this, e);
        }
        protected internal virtual void OnTabMouseUp(TabMouseEventArgs e) {
            TabMouseUp?.Invoke(this, e);
        }
        protected internal virtual void OnTabMouseMove(TabMouseEventArgs e) {
            TabMouseMove?.Invoke(this, e);
        }
        protected internal virtual void OnTabMouseWheel(TabMouseEventArgs e) {
            TabMouseWheel?.Invoke(this, e);
        }
        ...
        protected internal virtual void OnLayoutTabs(LayoutTabsEventArgs e) {
            LayoutTabs?.Invoke(this, e);
        }
        #endregion
        ...
        public TabControlRenderer Renderer {
            get {
                return renderer;
            }
            set {
        ...
        public bool ShowCloseTabButtons {
            get {
                return showCloseTabButtons;
            }
            set {
                showCloseTabButtons = value;
                UpdateTabLayout();
                UpdatePages();
            }
        }
        ...
        public override PageCollection Pages {
            get {
                return base.Pages;
            }
        }
       ...
       // [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public override Page SelectedPage {
            get {
        ...
        public Image LeftArrowImage {
            get {
                return (leftArrowImage ?? defaultLeftArrowImage);
            }
            set {
        ...
        public Image RightArrowImage {
            get {
                return (rightArrowImage ?? defaultRightArrowImage);
            }
            set {
        ...
        public Image UpArrowImage {
            get {
                return (upArrowImage ?? defaultUpArrowImage);
            }
            set {
                upArrowImage = value;
                UpdateTabLayout();
        ...
        public Image DownArrowImage {
            get {
                return (downArrowImage ?? defaultDownArrowImage);
            }
            set {
        ...
        protected internal override void OnPageAdded(PageEventArgs e) {
        ...
        protected internal override void OnPageRemoved(PageEventArgs e) {
            ((Tab)e.Page).ContentsChanged -= Tab_ContentsChanged;
        ...
        protected internal override void OnPageChanged(PageChangedEventArgs e) {
        ...
        protected internal ItemState GetTabState(Tab tab) {
            ...
            // hot
            if(ReferenceEquals(hoveredTab, tab))
                state |= ItemState.Hot;
            // pressed
            if(ReferenceEquals(mouseDownTab, tab))
                state |= ItemState.Pressed;
            // focused
            if(Parent.Focused && (ReferenceEquals(SelectedPage, tab)))
        ...
        protected internal ItemState GetTabCloseButtonState(Tab tab) {
            ...
            // hot
            if(ReferenceEquals(hoveredTab, tab) && hoveredButton)
                state |= ItemState.Hot;
            // pressed
            if(ReferenceEquals(mouseDownTab, tab) && mouseDownButton)
                state |= ItemState.Pressed;
            // focused
            if(Parent.Focused && (ReferenceEquals(SelectedPage, tab)))
                state |= ItemState.Focused;
